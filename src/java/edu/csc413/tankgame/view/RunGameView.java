...
import edu.csc413.tankgame.model.SmartAiTank;
...
import static edu.csc413.tankgame.model.PlayerTank.*;
...
public class RunGameView extends JPanel {
    ...
    private SmartAiTank smartTank;
    private DumbAiTank dumbTank;
    ...
    public void paintComponent(Graphics g) {
        ...
        g.drawString("Player", 30, 15);
        g.fillRect(80, 5, playerTank.getLife() * 20, 11);
        g.drawRect(80, 5, 80, 11);

        g.setColor(Color.yellow);
        g.drawString("Smart Tank ", 400, 15);
        g.fillRect(490, 5, smartTank.getLife() * 20, 11);
        g.drawRect(490, 5, 80, 11);

        g.setColor(Color.orange);
        g.drawString("Silly Tank ", 800, 15);
        g.fillRect(880, 5, dumbTank.getLife() * 20, 11);
        g.drawRect(880, 5, 80, 11);
        ...
        if (smartTank.getLife() == 0 && dumbTank.getLife() == 0) {
            f = new JFrame("Congratulation!");
            l = new JLabel();
            JPanel p = new JPanel();
            l.setText("You won!");
            p.add(l);
